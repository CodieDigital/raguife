...
import { Button } from "components/data/button/styles";
...
export default function LocalizacaoPage({ mapPoints }: LocalizacaoPageProps) {
  const [mapPointsState, setMapPointsState] = useState(mapPoints);
  ...
  async function HandleSearch(value) {
    const searchLocalization = mapPoints.filter((point) =>
      point.city.toLowerCase().includes(value.toLowerCase())
    );
    if (searchLocalization) {
      setMapPointsState(searchLocalization);
    } else {
      setMapPointsState(mapPoints);
    }
  }
  function getLocation(card: Point) {
  ...
  const apiIsLoaded = (map, maps, search) => {
    if (search) {
      ...
      setDefaultProps({ center: origin, zoom: 7 });
      ...
      <S.Localizacao>
        ...
        <div className="container-localizacao">
          <div className="results">
            ...
            {router.query.userLatitude && <a className="clean" href="/localizacao">Limpar rota</a>}
            <div className="cards-results">
              {mapPointsState.map((card) => {
                return (
                  ...
                  >
                    <h4 className="title-7-bold">{card.city}</h4>
                    ...
                    {card.whats && (
                      <div className="with-icon">
                        ...
                        <a href={"tel:" + card.whats}>{card.whats}</a>
                      </div>
                    )}
                    <button
                      type="button"
...
export const getServerSideProps: GetServerSideProps = async () => {
  const mapPoints = [
    {
      city: "Londrina",
      rua: "Av. Duque de Caxias, 1726 Vila Brasil, 86010-190",
      phone: "(43) 99646-3608",
      whats: "(43) 99646-3608",
      latitude: -23.317795937202238,
      longitude: -51.169885583716066,
    },
    {
      city: "Natal",
      rua: "Av. Duque de Caxias, 1726 Vila Brasil, 86010-190",
      phone: "(43) 99646-3608",
      whats: "(43) 99646-3608",
      latitude: -5.7944495758030445,
      longitude: -35.227740257593055,
    },
    {
      city: "Goiânia",
      rua: "Av. Duque de Caxias, 1726 Vila Brasil, 86010-190",
      phone: "(43) 99646-3608",
      whats: "(43) 99646-3608",
      latitude: -16.649831447557823,
      longitude: -49.2582621017044,
    },
  ];
  return {
    props: {
